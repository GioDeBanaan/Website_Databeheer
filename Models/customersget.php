...
class Customer
{
    ...
    {
        $sql = "SELECT customer_id,  first_name, last_name, gender, date_of_birth, email, phone, street, house_number, postal_code, city, country, registration_date, customer_status, loyalty_points, newsletter_subscribed, created_at, updated_at
                FROM customers
    ...
    public function create(array $data): int
    {
        ...
        $stmt->bindValue(':customer_status', $data['customer_status'], PDO::PARAM_STR);
        $stmt->bindValue(':loyalty_points', $data['loyalty_points'], PDO::PARAM_INT);
        $stmt->bindValue(':newsletter_subscribed', $data['newsletter_subscribed'], PDO::PARAM_INT);
        $stmt->execute();
