...
class Transaction
{
    ...
    {
        $sql = "SELECT transaction_id, transaction_code, transaction_type, customer_id, supplier_id, employee_id, game_id, transaction_date, quantity, unit_price, discount_percent, tax_percent, payment_method, payment_status, order_status, created_at, updated_at FROM transactions WHERE transaction_id = :id";
...
{
    $sql = "INSERT INTO transactions (transaction_code, transaction_type, customer_id, supplier_id, employee_id, game_id, transaction_date, quantity, unit_price, discount_percent, tax_percent, payment_method, payment_status, order_status, created_at, updated_at)
            VALUES (:transaction_code, :transaction_type, :customer_id, :supplier_id, :employee_id, :game_id, :transaction_date, :quantity, :unit_price, :discount_percent, :tax_percent, :payment_method, :payment_status, :order_status, NOW(), NOW())";
